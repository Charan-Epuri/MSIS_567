...
//                 sh '''cd Yaml_Kube
//                       aws s3 cp MSIS_567_V2_tmp.yml s3://kubefiles-ac/msis_567-$BUILD_NUMBER-1.yml
//                     '''        
//             }
//             post{
//                 failure{
...
//             environment{
//                 KUBEFILECMD="aws s3 cp s3://kubefiles-ac/msis_567-$BUILD_NUMBER-1.yml /tmp/msis_567-$BUILD_NUMBER-1.yml"
//                 KUBEDEPLOYCMD="kubectl apply -f /tmp/msis_567-$BUILD_NUMBER-1.yml"
//             }
//             steps{
//                 sh '''cd chef_cookbook
//                       cd kubenode
  	...
  	stage ('Prepare') {
        steps {
            checkout([$class: 'GitSCM', 
                ...
                userRemoteConfigs: [[credentialsId: 'git-credentials', url: 'https://github.com/Charan-Epuri/MSIS_567.git']]
            ])
        }
    }
    stage('buid') {
